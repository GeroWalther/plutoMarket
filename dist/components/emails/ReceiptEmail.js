...
var ReceiptEmail = function (_a) {
    ...
    var transactionFee = products.length * config_1.FEE;
    var total = products.reduce(function (acc, curr) { return acc + curr.price; }, 0) + transactionFee;
    return (React.createElement(components_1.Html, null,
        React.createElement(components_1.Head, null),
        React.createElement(components_1.Preview, null, "Your Pluto Market Receipt"),
        React.createElement(components_1.Body, { style: main },
            React.createElement(components_1.Container, { style: container },
                React.createElement(components_1.Section, null,
                    React.createElement(components_1.Column, null,
                        React.createElement(components_1.Img, { src: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/email.png"), width: '100', height: '100', alt: 'Pluto Market' })),
                ...
                React.createElement(components_1.Section, null,
                    ...
                    React.createElement(components_1.Column, { style: productPriceWrapper, align: 'right' },
                        React.createElement(components_1.Text, { style: productPrice }, (0, utils_1.formatPrice)(transactionFee)))),
                ...
                React.createElement(components_1.Text, { style: footerCopyright },
                    ...
                    ' ',
                    React.createElement(components_1.Link, { href: '#' }, "All rights reserved by GW-Intech"))))));
};
